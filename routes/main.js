...
router.post('/registerdata', function (req, res) {
  ...
  conn.query(sql, data, (error, results, fields) => {
    ...
    if (is_registerd != 'YES') {
      if (age >= 18) {
        var mailOptions = {
          from: 'shailendratrivedi004@gmail.com',
          to: 'shailendratrivedi009@gmail.com',
...
router.post('/otpverify', (req, res) => {
  ...
  if (otp == rand) {
    var record = { Account_address: account_address, Is_registered: 1 };
